...
For a FluentValidation example using `IEndpointFilter`, see the [Validation](../validation/) guide. For grouping endpoints, see the [Endpoint Groups](../endpoint-groups/) guide.
