...
By providing numerous self-contained API endpoints rather than grouping multiple endpoints into a controller class,
it enforces a structure where each endpoint is loosely coupled and easier to scale.
